...
<div
  ...
  login-url="https://userspace.sandbox.eosc-beyond.eu/users/auth/checkin"
  logout-url="https://userspace.sandbox.eosc-beyond.eu/users/logout"
></div>
```
...
<div
  ...
  data-login-url="https://userspace.sandbox.eosc-beyond.eu/users/auth/checkin"
  data-logout-url="https://userspace.sandbox.eosc-beyond.eu/users/logout"
></div>
```
